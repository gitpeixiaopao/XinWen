...
public class Main4Activity extends Activity implements View.OnClickListener {
    ...
    private Button xf_button1;
    private Button xf_button2;
    private TextView xf_textView;
    ...
    private void initView() {
        xf_button1 = (Button) findViewById(R.id.xf_button1);
        xf_button2 = (Button) findViewById(R.id.xf_button2);
        xf_textView = (TextView) findViewById(R.id.xf_textView);

        xf_button1.setOnClickListener(this);
        xf_button2.setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.xf_button1://语音识别(把语音转换成文本)
...
/*                System.out.println("讯飞识别的结果 " + resultString);
                System.out.println("b参数是什么 " + b);*/
                        ...
                        String content = parseData(resultString).toString();
//                System.out.println("解析后的数据 "+ content);
                ...
                mDialog.show();
                break;
            case R.id.xf_button2://语音合成（把文字转换成语音）
                String s = xf_textView.getText().toString();
                shuo(s);
